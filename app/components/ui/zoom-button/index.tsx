export const ZoomButton = () => {
  return (
    <button
      type="button"
      className="absolute bottom-8 right-6 size-20 flex justify-center items-center bg-[#1A1827] outline-none group-hover:bg-white rounded-full transition-all duration-300"
    >
      <svg
      ...
      >
        <path
          ...
          className="fill-white group-hover:fill-[#1A1827]"
        />
      </svg>
    </button>
  )
